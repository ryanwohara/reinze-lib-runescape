...
impl Skill for Construction {
    ...
    fn details(&self) -> Details {
        let details = match self {
            ...
            Self::MahoganyHomesBeginner => ("Mahog. Homes Beginner", 1, 500),
            ...
            Self::MahoganyHomesNovice => ("Mahog. Homes Novice", 1, 1250),
            ...
            Self::MahoganyHomesAdept => ("Mahog. Homes Adept", 1, 2250),
            ...
            Self::MahoganyHomesExpert => ("Mahog. Homes Expert", 1, 2750),
